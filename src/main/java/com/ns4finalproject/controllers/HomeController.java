...
public class HomeController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// Product Rau củ quả
		List<Product> product_domestictour= ProductDB.getProductsByCateId(1);
		req.setAttribute("product_domestictour", product_domestictour);
		
		// Product hạt
		List<Product> product_overseastour= ProductDB.getProductsByCateId(202);
		req.setAttribute("product_overseastour", product_overseastour);
		
		// Product trái cây
		List<Product> product_familytour= ProductDB.getProductsByCateId(3);
		req.setAttribute("product_familytour", product_familytour);
		
		// Product mật ong
		List<Product> product_featuredtour= ProductDB.getProductsByCateId(4);
		req.setAttribute("product_featuredtour", product_featuredtour);
