     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li style="color:#fff">Detail of carts</li>
        </ol>
      </div>
     </div>
   </div>
         ...
         <div class="cart-view-area">
           <div class="cart-view-table">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
          			 ...
          			 <tr>
                        <td colspan="6" class=""><strong>Total amount</strong></td>
             ...
             <div class="cart-view-total">
               ...
               <a href="${pageContext.request.contextPath}/view/client/checkout" class="aa-cart-view-btn">Checkout</a>
             </div>
           </div>
         </div>
       </div>
