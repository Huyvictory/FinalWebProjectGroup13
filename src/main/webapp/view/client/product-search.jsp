     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li style="color:#fff">Search Results</li>
        </ol>
      </div>
     </div>
   </div>
            ...
            <div class="aa-product-catg-body">
            	...
            	<c:choose>
	            	<c:when test="${empty productlist}"> 
	                   <p style="display:none;">Found results for keywords: <strong>${param.s}</strong></p>
	                </c:when>
	                <c:otherwise>
				       <p style="margin-bottom:30px;">Found results for keywords: <strong>${param.s}</strong></p>
				    </c:otherwise>
               </c:choose>
              ...
              <ul class="aa-product-catg">
                ...
                <c:if test="${empty productlist}">
                 	<p style="margin-left: 30px">Could not find any tour!</p>
                 </c:if>
