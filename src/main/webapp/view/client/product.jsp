...
<!--  content -->
  ...
  <section id="aa-catg-head-banner">
   <img src="${pageContext.request.contextPath}/view/client/assets/images/bandeira-horizontal-da-praia-com-palmeiras-e-parasol-113726913.png" alt="banner sản phẩm">
     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li style="color:#fff">List of tours</li>
        </ol>
      </div>
     </div>
   </div>
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <c:if test="${empty productlist}">
                 	<p style="margin-left: 30px">No tours yet!</p>
                 </c:if>
