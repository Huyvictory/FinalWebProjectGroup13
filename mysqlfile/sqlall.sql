...
INSERT INTO `admin` (`ID`, `NAME`, `PASSWORD`, `USERNAME`) VALUES (1,'admin','admin','admin'),(101,'huyvictory','huyhuy','huyhuy'),(701,'huyvictory','huyvictory','huyvictory');
...
INSERT INTO `boardnew` (`ID`, `AUTHOR`, `CONTENT`, `CREATED`, `IMAGE_LINK`, `TITLE`) VALUES ('201','Huy','voucher tour Phú Quốc - Nha Trang giảm giá đang giảm giá shock !!!!','2021-11-16','vourcherPhuQuocNhaTrang.png','voucher tour Phú Quốc - Nha Trang giảm giá'),('5','Tỏa','Về món ăn','2021-11-16','blog_1.jpg','Đi tour và ăn du lịch cùng bạn bè, gia đình');
...
INSERT INTO `catalog` (`ID`, `NAME`, `PARENT_ID`) VALUES ('1','DOMESTIC TOUR','1'),('202','OVERSEAS TOUR','1'),('3','FAMILY TOUR  ','1'),('4','FEATURED TOUR','1'),('5','NEW TOUR  ','1'),('6','FAVORITE TOUR','0'),('7','DISCOUNTED TOUR','0');
...
INSERT INTO `ordered` (`ID`, `PRODUCT_ID`, `QTY`, `TRANSACTION_ID`) VALUES ('302','251',1,301),('303','4',4,301),('352','251',1,351),('53','4',6,52),('552','453',1,551),('652','621',1,651),('653','505',1,651),('654','4',1,651),('655','604',1,651),('752','604',1,751);
...
INSERT INTO `review` (`ID`, `CONTENT`, `CREATED`, `EMAIL`, `NAME`, `PRODUCT_ID`) VALUES ('702','good tour','2021-11-22','vominhhuy008@gmail.com','18110020  Võ Minh Huy','251');
...
INSERT INTO `sequence` (`SEQ_NAME`, `SEQ_COUNT`) VALUES ('SEQ_GEN',800);
...
INSERT INTO `user` (`ID`, `CREATED`, `EMAIL`, `NAME`, `PASSWORD`, `PHONE`, `USERNAME`) VALUES (51,'2021-11-22','vominhhuy008@gmail.com','18110020  Võ Minh Huy','huyvictory','0867009603','huyvictory');
...
-- Dump completed on 2021-12-04 17:51:55
