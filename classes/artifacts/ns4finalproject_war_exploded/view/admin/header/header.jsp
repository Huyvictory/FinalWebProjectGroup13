...
<head>
  ...
  <title>Admin travel agency website</title>
        ...
        <ul class="navbar-nav align-items-center right-nav-link">
          <li class="nav-item">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javaScript:void();">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h6 class="mt-2 user-title">TravelAgencyWebsite</h6>
			 ...
			 <li class="dropdown-item"><i class="icon-power mr-2"></i><a href="${pageContext.request.contextPath}/admin/logout">Sign out</a></li>
            </ul>
          </li>
        </ul>
      </nav>
