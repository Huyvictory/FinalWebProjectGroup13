              ...
              <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/admin/user/edit" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-2" placeholder="FullName" value="${user.name}" name="user-name">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-4" placeholder="Phone Number" value="${user.phone}" name="user-phone">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="myinput" placeholder="Password" value="${user.password}" name="user-password">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="input-6" placeholder="Create Date" value="${user.created}" name="user-created">
                  </div>
