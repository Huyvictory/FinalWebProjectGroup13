     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li style="color:#fff">Details to checkout</li>
        </ol>
      </div>
     </div>
   </div>
                ...
                <div class="checkout-left">
                  <div class="panel-group" >
                   <c:if test="${sessionScope.username == null}">
                   		<p> You need to log in to check out <a href="${pageContext.request.contextPath}/view/client/login" style="color: #754110">here!</a></p>
                   </c:if>
				 <c:if test="${sessionScope.username != null}">
                    <!-- Shipping Address -->
                         ...
                         <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <input type="text" placeholder="Full Name*" required="required" name="transaction_name">
                              </div>                             
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="tel" placeholder="Phone number*" required="required" name="transaction_phone">
                              </div>
                            </div>
                          </div> 
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <textarea cols="8" rows="3" required="required" placeholder="Address*" name="transaction_address"></textarea>
                              </div>                             
                            </div>                            
                          </div>
                           <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <textarea cols="8" rows="3" placeholder="Note" name="transaction_mess"></textarea>
                              </div>                             
                            </div>                            
                          </div>     
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-payment-method">                    
                    <label for="cashdelivery"><input type="radio" id="cashdelivery" name="transaction_payment" checked value="0"> Pay when already received confirmation (COD) </label>
                    <label for="paypal"><input type="radio" id="paypal" name="transaction_payment" value="1" > Pay with credit card (ATM) </label>
                   ...
                   <br>
                   		<p style="color: red">Make purchase successfully!</p>
                   </c:if>
                </div>
              </div>
            </div>
